...
[~,~,~,~,~,Sa5,~,~] = SDOF_Response(T, z5, ag_SLAC1_sc_mce, dt, 0, 0);
Sa_S1_mce = Sa5/g;

[~,~,~,~,~,Sa5,~,~] = SDOF_Response(T, z5, ag_SLAC2_sc_mce, dt, 0, 0);
Sa_S2_mce = Sa5/g;

[~,~,~,~,~,Sa5,~,~] = SDOF_Response(T, z5, ag_VA1_sc_mce, dt, 0, 0);
Sa_V1_mce = Sa5/g;

[~,~,~,~,~,Sa5,~,~] = SDOF_Response(T, z5, ag_VA2_sc_mce, dt, 0, 0);
Sa_V2_mce = Sa5/g;
...
Vy_mce = Sa_design_mce / R;

% Cm = 0 because "other" structure
Cm = 1.0;

mu_S1_mce = Sa_S1_mce / Vy_mce * Cm;
mu_S2_mce = Sa_S2_mce / Vy_mce * Cm;
mu_V1_mce = Sa_V1_mce / Vy_mce * Cm;
mu_V2_mce = Sa_V2_mce / Vy_mce * Cm;
